...
@section('breadcrumb', 'Edit Service Type')
        ...
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    ...
                    <p class="text-muted mb-0">Modify service type: {{ $serviceType->name }}</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('service-types.update', $serviceType) }}">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number"
                                           ...
                                           id="hourly_rate"
                                           name="hourly_rate"
                                           value="{{ old('hourly_rate', $serviceType->hourly_rate) }}"
                                           step="0.01"
                                           min="0"
                                           required>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number"
                                       ...
                                       value="{{ old('estimated_duration_minutes', $serviceType->estimated_duration_minutes) }}"
                                       min="15"
                                       step="15"
                                       required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror"
                                      ...
                                      name="description"
                                      rows="4"
                                      placeholder="Describe the service, what's included, and any special requirements...">{{ old('description', $serviceType->description) }}</textarea>
                            @error('description')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="fas fa-save me-2"></i>Update Service Type
                            </button>
                        </div>
                    </form>
                </div>
