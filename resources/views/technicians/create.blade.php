...
@section('breadcrumb', 'Create Technician')
    ...
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2 class="mb-0">
                        <i class="fas fa-plus me-2"></i>Create Technician
                    </h2>
                    <p class="text-muted mb-0">Add a new technician to your team</p>
                </div>
                    ...
                    <form method="POST" action="{{ route('technicians.store') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('specialties') is-invalid @enderror"
                                      ...
                                      name="specialties"
                                      rows="3"
                                      placeholder="Enter specialties separated by commas (e.g., HVAC, Electrical, Plumbing)">{{ old('specialties') }}</textarea>
                            @error('specialties')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
